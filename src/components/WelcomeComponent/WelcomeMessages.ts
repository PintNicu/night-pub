export const summerMessage = {
    ...
    longMessage: `Simți căldura verii? Vino să te răcorești la barul nostru! Cu o
            ...
            avem ceva pentru fiecare gust. Nu rata happy hour-ul nostru special -
            relaxează-te și savurează după o zi lungă!`
}
...
export const winterMessage = {
    ...
    longMessage: ` Afară e frig și zăpadă? Vino să te încălzești la barul nostru primitor! 
            ...
            iarnă unice, avem tot ce-ți trebuie pentru a topi frigul. Nu rata 
            specialitățile noastre de sezon - relaxează-te și lasă-te cuprins de 
            căldura și confortul barului nostru în aceste seri reci de iarnă!`
}
...
export const autumnMessage = {
    ...
    longMessage: `Frunzele cad, iar serile devin mai răcoroase? E momentul perfect să 
            ...
            De la cocktailuri cu mere și scorțișoară, la licori aromate cu dovleac, 
            avem tot ce-ți trebuie pentru a sărbători această perioadă minunată a 
            anului. Alătură-te nouă pentru seri pline de culoare, arome îmbietoare 
            și conversații plăcute - locul ideal pentru a te bucura de magia toamnei!`
}
...
export const springMessage = {
    ...
    longMessage: `Pomii înfloresc, iar zilele devin mai lungi și mai calde? E momentul perfect
                  ...
                  De la cocktailuri cu fructe proaspete și flori comestibile, la băuturi
                  răcoritoare cu mentă și citrice, avem tot ce-ți trebuie pentru a sărbători
                  această perioadă minunată a anului. Alătură-te nouă pentru seri pline de
                  culoare, arome proaspete și conversații antrenante - locul ideal pentru a te
                  bucura de energia revigorantă a primăverii!`
}
...
export const championshipSeasonMessage = {
    ...
    longMessage: `A început sezonul Campionatului și febra fotbalului e în toi! Vino să 
            ...
            electrizantă, nu vei rata nicio fază importantă. Savurează băuturile noastre 
            speciale inspirate din echipele favorite și gustă din meniul nostru perfect 
            pentru fanii fotbalului. Fie că vii să susții echipa ta sau doar să te 
            bucuri de spectacol, aici vei găsi cea mai tare experiență de vizionare. 
            Hai să facem galerie împreună și să sărbătorim victoriile! Rezervă-ți locul 
            acum pentru meciurile importante!`
}